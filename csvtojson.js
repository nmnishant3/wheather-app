window.csv = (function (t) {
    ...
    (function (t) {
      ...
      (u.prototype.slice = function (t, e) {
        ...
        (u.prototype.fill = function (t, e, r, n) {
          if ("string" == typeof t) {
            if (
              ("string" == typeof e ? ((n = e), (e = 0), (r = this.length)) : "string" == typeof r && ((n = r), (r = this.length)), 1 === t.length)
            ) {
  ...
  function (t, e) {
    ...
    (t.exports = r),
      ...
      (r.prototype.removeListener = function (t, e) {
        ...
        if (((s = (r = this._events[t]).length), (o = -1), r === e || (n(r.listener) && r.listener === e)))
  ...
  function (t, e, r) {
    ((e = t.exports = r(22)).Stream = e), (e.Readable = e), (e.Writable = r(13)), (e.Duplex = r(1)), (e.Transform = r(27)), (e.PassThrough = r(45));
  },
  function (t, e, r) {
    "use strict";
    (function (e, n, i) {
            ...
            !(function (t, e) {
              ...
              if (
                ...
                !(function (t, e, r, n, i) {
                  --e.pendingcb,
                    r
                      ? (o.nextTick(i, n), o.nextTick(x, t, e), (t._writableState.errorEmitted = !0), t.emit("error", n))
                      : (i(n), (t._writableState.errorEmitted = !0), t.emit("error", n), x(t, e));
                })(t, r, n, e, i);
              else {
                var s = E(r);
            ...
            ((function (t, e) {
              e.prefinished ||
                ...
                ("function" == typeof t._final
                  ? (e.pendingcb++, (e.finalCalled = !0), o.nextTick(C, t, e))
      ...
      c.inherits(m, h),
        ...
        (m.prototype.setDefaultEncoding = function (t) {
          if (
            ...
            !(
              ["hex", "utf8", "utf-8", "ascii", "binary", "base64", "ucs2", "ucs-2", "utf16le", "utf-16le", "raw"].indexOf((t + "").toLowerCase()) >
              -1
            ))
          )
    ...
    }.call(this, r(4), r(25).setImmediate, r(0)));
  },
  function (t, e, r) {
    (function (e, r, n) {
      ...
      })(
        {
            ...
            function (t, r, n) {
              ...
              (u.prototype.setScheduler = function (t) {
                ...
                a.hasDevTools
                  ...
                  : ((u.prototype.invokeLater = c), (u.prototype.invoke = l), (u.prototype.settlePromises = f)),
                ...
                (e.prototype.break = e.prototype.cancel =
                  ...
                  (e.prototype._cancelBy = function (t) {
                    return t === this
                      ...
                      : (this._branchHasCancelled(), !!this._enoughBranchesHaveCancelled() && (this._invokeOnCancel(), !0));
                  }),
              ...
              r.exports = function (r, n) {
                ...
                (r.longStackTraces = function () {
                  ...
                  if (!J.longStackTraces && Y()) {
                    ...
                    (J.longStackTraces = !0),
                      ...
                      (r.prototype._captureStackTrace = D),
                      (r.prototype._attachExtraTrace = I),
                ...
                var j = {
                  ...
                  R = function (t) {
                    ...
                    var r = !1;
                    try {
                      r = C(t, j[t].apply(null, arguments));
                    } catch (t) {
                      u.throwLater(t), (r = !0);
                    }
                    return r || e;
                ...
                (r.config = function (t) {
                  if (
                    ("longStackTraces" in (t = Object(t)) &&
                      (t.longStackTraces ? r.longStackTraces() : !t.longStackTraces && r.hasLongStackTraces() && E()),
                    "warnings" in t)
                  ) {
                    var e = t.warnings;
                  ...
                  if ("cancellation" in t && t.cancellation && !J.cancellation) {
                    ...
                    (r.prototype._clearCancellationData = F),
                      (r.prototype._propagateFrom = L),
                      (r.prototype._onCancel = O),
                      (r.prototype._setOnCancel = A),
                      (r.prototype._attachCancellationCallback = P),
                      (r.prototype._execute = T),
                      (M = L),
                      (J.cancellation = !0);
                  }
                  return (
                    "monitoring" in t &&
                      (t.monitoring && !J.monitoring
                        ? ((J.monitoring = !0), (r.prototype._fireEvent = R))
                        : !t.monitoring && J.monitoring && ((J.monitoring = !1), (r.prototype._fireEvent = k))),
                    r
                  );
                }),
                  (r.prototype._fireEvent = k),
                  ...
                  return (
                    (e =
                      "string" == typeof e && e.length > 0
                        ...
                        : ["    (No stack trace)"]),
                    { message: r, stack: "SyntaxError" == t.name ? e : N(e) }
                  );
                }
                function V(t, e, r) {
                ...
                function W(t) {
                  ...
                  if ("function" == typeof t) e = "[function " + (t.name || "anonymous") + "]";
                    ...
                    if (((e = t && "function" == typeof t.toString ? t.toString() : l.toString(t)), /\[object [a-zA-Z0-9$_]+\]/.test(e)))
                      try {
                        e = JSON.stringify(t);
                      } catch (t) {}
                    ...
                    if (!(t < 2)) {
                      ...
                      for (n = 0; n < t; ++n) {
                        ...
                        if (void 0 !== s && s !== n) {
                          ...
                          s < t - 1
                            ? ((a._parent = e[s + 1]), a._parent.uncycle(), (a._length = a._parent._length + 1))
                ...
                var G = (function () {
                  ...
                  return "stack" in i || !n || "number" != typeof Error.stackTraceLimit
                    ? ((v = function (t, e) {
                        return "string" == typeof t
                          ? t
                ...
                var J = { warnings: g, longStackTraces: !1, cancellation: !1, monitoring: !1 };
                return (
                  b && r.longStackTraces(),
                  {
                ...
                (t.prototype.return = t.prototype.thenReturn =
                  ...
                  (t.prototype.catchReturn = function (r) {
                    if (arguments.length <= 1)
                      return r instanceof t && r.suppressUnhandledRejections(), this._then(void 0, e, void 0, { value: r }, void 0);
                    var n = arguments[1];
                    return (
          ...
          12: [
            function (t, e, r) {
              ...
              g ||
                ((g = s({ CancellationError: h, TimeoutError: p, OperationalError: m, RejectionError: m, AggregateError: d })),
                o.defineProperty(Error, "__BluebirdErrorTypes__", { value: g, writable: !1, enumerable: !1, configurable: !1 })),
                (e.exports = {
                  Error: Error,
                  TypeError: n,
                  RangeError: i,
                  ...
                  (h.prototype._promiseCancelled = function () {
                    if (!this._isResolved()) {
                      ...
                      if (void 0 !== this._generator.return)
                        this._promise._pushContext(), (t = l(this._generator.return).call(this._generator, void 0)), this._promise._popContext();
                      else {
                        var r = new e.CancellationError("generator .return() sentinel");
                        (e.coroutine.returnSentinel = r),
                          this._promise._attachExtraTrace(r),
                          this._promise._pushContext(),
                          (t = l(this._generator.throw).call(this._generator, r)),
              ...
              r.exports = function () {
                ...
                return (
                  ...
                  (T.prototype.spread = function (t) {
                    return "function" != typeof t
                      ? o("expecting a function but got " + c.classString(t))
                  ...
                  (T.prototype._then = function (t, e, r, n, i) {
                    ...
                    o ||
                      ...
                      void 0 === n &&
                        ...
                        (n = 0 != (50397184 & l) ? this._boundValue() : u === this ? void 0 : this._boundTo),
                    ...
                    if (0 != (50397184 & l)) {
                      ...
                      0 != (33554432 & l)
                        ? ((d = u._rejectionHandler0), (p = t))
                        : 0 != (16777216 & l)
                        ? ((d = u._fulfillmentHandler0), (p = e), u._unsetRejectionIsUnhandled())
                        : ((y = u._settlePromiseLateCancellationObserver),
                          (d = new _("late cancellation observer")),
                          u._attachExtraTrace(d),
                          (p = e)),
                        h.invoke(y, u, { handler: null === f ? p : "function" == typeof p && c.domainBind(f, p), promise: s, receiver: n, value: d });
                  ...
                  (T.prototype._addCallbacks = function (t, e, r, n, i) {
                    ...
                    if ((o >= 65531 && ((o = 0), this._setLength(0)), 0 === o))
                      ...
                      (this[s + 2] = r),
                        (this[s + 3] = n),
                        "function" == typeof t && (this[s + 0] = null === i ? t : c.domainBind(i, t)),
                    ...
                    if (0 == (65536 & i)) {
                      ...
                      n._pushContext(),
                        e === y
                          ? r && "number" == typeof r.length
                            ? (o = k(t).apply(this._boundValue(), r))
                            : ((o = R).e = new d("cannot .spread() a non-array: " + c.classString(r)))
                          : (o = k(t).call(e, r));
                      var s = n._popContext();
                      0 == (65536 & (i = n._bitField)) &&
                        (o === m
                          ...
                          : (C.checkForgottenReturns(o, s, "", n, this), n._resolveCallback(o)));
                    }
                  }),
                    ...
                    0 != (65536 & a)
                      ? (o && t._invokeInternalOnCancel(),
                        r instanceof x && r.isFinallyHandler()
                          ? ((r.cancelPromise = t), k(e).call(r, n) === R && t._reject(R.e))
                          : e === i
                          ? t._fulfill(i.call(r))
                          : r instanceof s
                      ...
                      : "function" == typeof e
                      ? o
                        ? (u && t._setAsyncGuaranteed(), this._settlePromiseFromHandler(e, r, n, t))
                        : e.call(r, n, t)
                      : r instanceof s
                      ? r._isResolved() || (0 != (33554432 & a) ? r._promiseFulfilled(n, t) : r._promiseRejected(n, t))
                      : o && (u && t._setAsyncGuaranteed(), 0 != (33554432 & a) ? t._fulfill(n) : t._reject(n));
                  }),
                  ...
                  c.notEnumerableProp(T, "_makeSelfResolutionError", n),
                  t("./method")(T, v, g, o, C),
                  t("./bind")(T, v, g, C),
                  t("./cancel")(T, b, o, C),
                  t("./direct_resolve")(T),
                  ...
                  (T.Promise = T),
                  (T.version = "3.5.1"),
                  t("./map.js")(T, b, o, g, v, C),
                  t("./call_get.js")(T),
                  t("./using.js")(T, o, g, E, v, C),
                  t("./timers.js")(T, v, C),
                  t("./generators.js")(T, o, v, g, s, C),
                  t("./nodeify.js")(T),
                  t("./promisify.js")(T, v),
                  t("./props.js")(T, b, g, o),
                  t("./race.js")(T, v, g, o),
                  t("./reduce.js")(T, b, o, g, v, C),
                  t("./settle.js")(T, b, C),
                  t("./some.js")(T, b, o),
                  t("./filter.js")(T, v),
                  t("./each.js")(T, v),
                  t("./any.js")(T),
                  c.toFastProperties(T),
                  c.toFastProperties(T.prototype),
                  A({ a: 1 }),
                  A({ b: 2 }),
                  A({ c: 3 }),
                  A(1),
                  ...
                  A(!1),
                  A(new T(v)),
                  C.setBounds(f.firstLineError, c.lastLineError),
                  T
                );
              };
            },
                ...
                return (
                  ...
                  (a.prototype._iterate = function (t) {
                    ...
                    for (var i = this._promise, o = !1, s = null, a = 0; a < r; ++a) {
                      var u = n(t[a], i);
                      (s = u instanceof e ? (u = u._target())._bitField : null),
                        o
                  ...
                  (a.prototype._resultCancelled = function () {
                    if (!this._isResolved()) {
                      ...
                      else for (var r = 0; r < t.length; ++r) t[r] instanceof e && t[r].cancel();
                    }
                  }),
              ...
              e.exports = function (e, r) {
                ...
                (e.promisify = function (t, e) {
                  ...
                  (e.promisifyAll = function (t, e) {
                    ...
                    var s = e.promisifier;
                    if (("function" != typeof s && (s = m), !i.isIdentifier(n)))
              ...
              e.exports = function (e, r, n, i) {
                ...
                function f(t) {
                  var r,
                    o = n(t);
                  return a(o)
                    ? ((r = o instanceof e ? o._then(e.props, void 0, void 0, void 0, void 0) : new l(o).promise()),
            ...
            function (t, e, r) {
              ...
              e.exports = function (e, r, n, i, o, s) {
                ...
                function l(t, r, n, i) {
                  this.constructor$(t);
                  var s = a();
                  (this._fn = null === s ? r : u.domainBind(s, r)),
                  ...
                  i._pushContext(),
                    (r =
                      void 0 !== n._eachValues
                        ...
                        : o.call(i._boundValue(), this.accum, t, this.index, this.length)) instanceof e && (n._currentCancellable = r);
                  var a = i._popContext();
                ...
                u.inherits(l, r),
                  ...
                  (l.prototype._iterate = function (t) {
                    ...
                    var i = t.length;
                    if (
                      (void 0 !== this._initialValue ? ((r = this._initialValue), (n = 0)) : ((r = e.resolve(t[0])), (n = 1)),
                  ...
                  if (o(t)) {
                    ...
                    if ("function" == typeof u)
                      return (function (t) {
                        ...
                        ? ((c = new e(r)), t._then(c._fulfill, c._reject, void 0, c, null), c)
                        : (function (t, o, s) {
                            var a = new e(r),
                              u = a;
              ...
              e.exports = function (e, r, n) {
                ...
                var a = function (t) {
                  ...
                  u = (e.delay = function (t, i) {
                    ...
                    return (
                      void 0 !== i
                        ? ((o = e.resolve(i)._then(a, null, null, t, void 0)), n.cancellation() && i instanceof e && o._setOnCancel(i))
                        : ((o = new e(r)),
                          (u = setTimeout(function () {
                            o._fulfill();
                          }, +t)),
                          n.cancellation() && o._setOnCancel(new s(u)),
                ...
                (e.prototype.delay = function (t) {
                  ...
                  (e.prototype.timeout = function (t, e) {
                    ...
                    return (
                      n.cancellation()
                        ? ((a = this.then()), (r = a._then(c, l, void 0, u, void 0))._setOnCancel(u))
                  ...
                  (e.using = function () {
                    ...
                    for (var c = new m(t), h = 0; h < t; ++h) {
                      ...
                      if (_.isDisposer(p)) {
                        ...
                        var g = n(p);
                        g instanceof e && (p = g._then(y, null, null, { resources: c, index: h }, void 0));
                      }
                      c[h] = p;
                    }
    ...
    }.call(this, r(4), r(0), r(25).setImmediate));
  },
  function (t, e, r) {
    "use strict";
  ...
  function (t, e, r) {
    ...
    (function (e, n) {
      ...
      var o,
        s = r(36);
      (g.ReadableState = m), r(11).EventEmitter;
      var a = function (t, e) {
      ...
      function m(t, e) {
        ...
        (this.highWaterMark = i || 0 === i ? i : n && (s || 0 === s) ? s : a),
          ...
          (this.decoder = null),
          (this.encoding = null),
          t.encoding && (d || (d = r(26).StringDecoder), (this.decoder = new d(t.encoding)), (this.encoding = t.encoding));
      }
      function g(t) {
              ...
              o
                ...
                ? ("string" == typeof e ||
                  ...
                  n
                    ...
                    : ((s.reading = !1),
                      s.decoder && !r ? ((e = s.decoder.write(e)), s.objectMode || 0 !== e.length ? w(t, s, e, !1) : j(t, s)) : w(t, s, e, !1)))
                : n || (s.reading = !1)),
          (function (t) {
      ...
      function w(t, e, r, n) {
        e.flowing && 0 === e.length && !e.sync
          ...
          : ((e.length += e.objectMode ? 1 : r.length), n ? e.buffer.unshift(r) : e.buffer.push(r), e.needReadable && x(t)),
          j(t, e);
      }
      Object.defineProperty(g.prototype, "destroyed", {
        ...
        (g.prototype.push = function (t, e) {
          ...
          return (
            n.objectMode
              ? (r = !0)
              : "string" == typeof t && ((e = e || n.defaultEncoding) !== n.encoding && ((t = c.from(t, e)), (e = "")), (r = !0)),
            b(this, t, e, !1, r)
          );
        }),
      ...
      function R(t, e) {
        for (
          var r = e.length;
          !e.reading && !e.flowing && !e.ended && e.length < e.highWaterMark && (p("maybeReadMore read 0"), t.read(0), r !== e.length);
      ...
      (g.prototype.read = function (t) {
        ...
        if ((0 !== t && (e.emittedReadable = !1), 0 === t && e.needReadable && (e.length >= e.highWaterMark || e.ended)))
          return p("read: emitReadable", e.length, e.ended), 0 === e.length && e.ended ? A(this) : x(this), null;
        ...
        return (
          ...
          e.ended || e.reading
            ...
            : i &&
              ...
              (e.sync = !1),
              e.reading || (t = C(r, e))),
          null === (n = t > 0 ? O(t, e) : null) ? ((e.needReadable = !0), (t = 0)) : (e.length -= t),
        ...
        (g.prototype.pipe = function (t, e) {
          ...
          function d(e) {
            p("ondata"),
              ...
              !1 !== t.write(e) ||
                h ||
                (((1 === o.pipesCount && o.pipes === t) || (o.pipesCount > 1 && -1 !== L(o.pipes, t))) &&
                  !f &&
                  (p("false write response, pause", r._readableState.awaitDrain), r._readableState.awaitDrain++, (h = !0)),
                r.pause());
          }
          function _(e) {
        ...
        (g.prototype.unpipe = function (t) {
          ...
          if (1 === e.pipesCount)
            return t && t !== e.pipes
              ? this
              : (t || (t = e.pipes), (e.pipes = null), (e.pipesCount = 0), (e.flowing = !1), t && t.emit("unpipe", this, r), this);
          if (!t) {
            var n = e.pipes,
              i = e.pipesCount;
          ...
          return -1 === s
            ? this
            : (e.pipes.splice(s, 1), (e.pipesCount -= 1), 1 === e.pipesCount && (e.pipes = e.pipes[0]), t.emit("unpipe", this, r), this);
        }),
        (g.prototype.on = function (t, e) {
          ...
          if ("data" === t) !1 !== this._readableState.flowing && this.resume();
            ...
            n.endEmitted ||
              n.readableListening ||
              ((n.readableListening = n.needReadable = !0), (n.emittedReadable = !1), n.reading ? n.length && x(this) : i.nextTick(k, this));
          }
          return r;
        }),
        ...
        (g.prototype.wrap = function (t) {
          ...
          t.on("data", function (i) {
            p("wrapped data"),
              ...
              (!r.objectMode || (null !== i && void 0 !== i)) && (r.objectMode || (i && i.length)) && (e.push(i) || ((n = !0), t.pause()));
          }),
          t))
            void 0 === this[i] &&
              "function" == typeof t[i] &&
  ...
  function (t, e, r) {
    ...
    (function (t) {
      Object.defineProperty(e, "__esModule", { value: !0 }),
        ...
        (e.trimLeft = String.prototype.trimLeft
          ? function (t) {
              return t.trimLeft();
            }
          : function (t) {
  ...
  function (t, e, r) {
    ...
    var i = (function (t) {
      ...
      return (
        n(e, t),
        (e.column_mismatched = function (t, r) {
    ...
    var o = r(35),
      ...
      f = (function (t) {
        function e(e, r) {
          ...
          return (
            (n.options = r),
            (n.params = s.mergeParams(e)),
            (n.runtime = a.initParseRuntime(n)),
            (n.result = new l.Result(n)),
            (n.processor = new c.ProcessorLocal(n)),
            n.once("error", function (t) {
              setTimeout(function () {
                n.result.processError(t), n.emit("done", t);
              }, 0);
            }),
            n.once("done", function () {
              n.processor.destroy();
            }),
            n
          );
        ...
        return (
          n(e, t),
          (e.prototype.preRawData = function (t) {
            return (this.runtime.preRawDataHook = t), this;
          }),
          (e.prototype.preFileLine = function (t) {
            return (this.runtime.preFileLineHook = t), this;
          }),
          (e.prototype.subscribe = function (t, e, r) {
            return (this.parseRuntime.subscribe = { onNext: t, onError: e, onCompleted: r }), this;
          }),
          (e.prototype.fromFile = function (t, e) {
            var n = this,
              i = r(
                !(function () {
            ...
            return (
              i.exists(t, function (r) {
                r
                  ? i.createReadStream(t, e).pipe(n)
                  : n.emit("error", new Error("File does not exist. Check to make sure the file path to your csv is correct."));
              }),
              this
            );
          }),
          (e.prototype.fromStream = function (t) {
          ...
          Object.defineProperty(e.prototype, "parseParam", {
            get: function () {
              return this.params;
            },
            enumerable: !0,
          ...
          Object.defineProperty(e.prototype, "parseRuntime", {
            get: function () {
              return this.runtime;
            },
            enumerable: !0,
          ...
          (e.prototype.processEnd = function (t) {
            this.result.endProcess(), this.emit("done"), t();
          }),
          Object.defineProperty(e.prototype, "parsedLineNumber", {
            get: function () {
    ...
    (e.byteLength = function (t) {
      ...
      (e.toByteArray = function (t) {
        ...
        return (
          ...
          1 === s &&
            ((e = (i[t.charCodeAt(f)] << 10) | (i[t.charCodeAt(f + 1)] << 4) | (i[t.charCodeAt(f + 2)] >> 2)),
            (a[u++] = (e >> 8) & 255),
            (a[u++] = 255 & e)),
          a
        );
  ...
  function (t, e, r) {
    t.exports = r(12).Transform;
  },
  function (t, e, r) {
    t.exports = r(12).PassThrough;
  },
  function (t, e, r) {
    "use strict";
    Object.defineProperty(e, "__esModule", { value: !0 }),
      ...
      var o = r(53),
        ...
        d = (function (e) {
          function r() {
            ...
            return (
              (t.rowSplit = new f.RowSplit(t.converter)),
              (t.eolEmitted = !1),
              (t._needEmitEol = void 0),
              (t.headEmitted = !1),
              (t._needEmitHead = void 0),
              t
            );
          }
          return (
            ...
            (r.prototype.flush = function () {
              ...
              if (this.runtime.csvLineBuffer && this.runtime.csvLineBuffer.length > 0) {
                ...
                return (
                  ...
                  this.process(e, !0).then(function (e) {
                    return t.runtime.csvLineBuffer && t.runtime.csvLineBuffer.length > 0
                      ? s.default.reject(p.default.unclosed_quote(t.runtime.parsedLineNumber, t.runtime.csvLineBuffer.toString()))
                      : s.default.resolve(e);
                  })
                );
              }
            ...
            (r.prototype.process = function (t, e) {
              ...
              return (
                void 0 === e && (e = !1),
                (r = e ? t.toString() : a.prepareData(t, this.converter.parseRuntime)),
                s.default
                  .resolve()
                  .then(function () {
            ...
            (r.prototype.processCSV = function (t, e) {
              var r = this,
                ...
                i = this.runtime;
              i.eol || u.default(t, i),
                this.needEmitEol && !this.eolEmitted && i.eol && (this.converter.emit("eol", i.eol), (this.eolEmitted = !0)),
                n.ignoreEmpty && !i.started && (t = l.trimLeft(t));
              var o = c.stringToLines(t, i);
              return (
                e ? (o.lines.push(o.partial), (o.partial = "")) : this.prependLeftBuf(l.bufFromString(o.partial)),
                o.lines.length > 0
                  ? (i.preFileLineHook ? this.runPreLineHook(o.lines) : s.default.resolve(o.lines)).then(function (t) {
            ...
            (r.prototype.processDataWithHead = function (t) {
              ...
              return (
                ...
                this.needEmitHead && !this.headEmitted && (this.converter.emit("header", this.runtime.headers), (this.headEmitted = !0)),
                this.processCSVBody(t)
              );
            }),
                ...
                for (var t = this.runtime.headers, e = 0; e < t.length; e++)
                  if (this.params.ignoreColumns)
                    ...
                    this.params.includeColumns
                      ? this.params.includeColumns.test(t[e]) && this.runtime.selectedColumns.push(e)
                      : this.runtime.selectedColumns.push(e);
            ...
            (r.prototype.processCSVBody = function (t) {
              ...
              return (
                this.prependLeftBuf(l.bufFromString(e.partial)), "csv" === this.params.output ? e.rowsCells : h.default(e.rowsCells, this.converter)
              );
            }),
            (r.prototype.prependLeftBuf = function (e) {
              e &&
                (this.runtime.csvLineBuffer
                  ? (this.runtime.csvLineBuffer = t.concat([e, this.runtime.csvLineBuffer]))
                  : (this.runtime.csvLineBuffer = e));
            }),
  ...
  function (t, e, r) {
    ...
    (function (e) {
      var n = r(56);
      t.exports = function (t) {
        return "string" == typeof t && 65279 === t.charCodeAt(0)
          ? t.slice(1)
          : e.isBuffer(t) && n(t) && 239 === t[0] && 187 === t[1] && 191 === t[2]
          ? t.slice(3)
          : t;
      };
    }.call(this, r(3).Buffer));
    ...
    t.exports = function (t) {
      for (var e = 0; e < t.length; )
        if (9 == t[e] || 10 == t[e] || 13 == t[e] || (32 <= t[e] && t[e] <= 126)) e += 1;
          ...
          (224 == t[e] && 160 <= t[e + 1] && t[e + 1] <= 191 && 128 <= t[e + 2] && t[e + 2] <= 191) ||
          (((225 <= t[e] && t[e] <= 236) || 238 == t[e] || 239 == t[e]) &&
            128 <= t[e + 1] &&
            t[e + 1] <= 191 &&
            128 <= t[e + 2] &&
            t[e + 2] <= 191) ||
          (237 == t[e] && 128 <= t[e + 1] && t[e + 1] <= 159 && 128 <= t[e + 2] && t[e + 2] <= 191)
        )
          e += 3;
        else {
          if (
            !(
              (240 == t[e] && 144 <= t[e + 1] && t[e + 1] <= 191 && 128 <= t[e + 2] && t[e + 2] <= 191 && 128 <= t[e + 3] && t[e + 3] <= 191) ||
              (241 <= t[e] &&
                t[e] <= 243 &&
                128 <= t[e + 1] &&
                t[e + 1] <= 191 &&
                ...
                128 <= t[e + 3] &&
                t[e + 3] <= 191) ||
              (244 == t[e] && 128 <= t[e + 1] && t[e + 1] <= 143 && 128 <= t[e + 2] && t[e + 2] <= 191 && 128 <= t[e + 3] && t[e + 3] <= 191)
            )
          )
            return !1;
          e += 4;
    ...
    var i = n(r(15)),
      ...
      a = (function () {
        function t(t) {
          (this.conv = t),
            (this.cachedRegExp = {}),
            (this.delimiterEmitted = !1),
            (this._needEmitDelimiter = void 0),
            (this.quote = t.parseParam.quote),
            (this.trim = t.parseParam.trim),
            (this.escape = t.parseParam.escape);
        }
        return (
          Object.defineProperty(t.prototype, "needEmitDelimiter", {
            get: function () {
              return (
                void 0 === this._needEmitDelimiter && (this._needEmitDelimiter = this.conv.listeners("delimiter").length > 0), this._needEmitDelimiter
              );
            },
            enumerable: !0,
            configurable: !0,
          ...
          (t.prototype.parse = function (t) {
            if (0 === t.length || (this.conv.parseParam.ignoreEmpty && 0 === t.trim().length)) return { cells: [], closed: !0 };
            var e = this.quote,
              r = this.trim;
            this.escape,
              (this.conv.parseRuntime.delimiter instanceof Array || "auto" === this.conv.parseRuntime.delimiter.toLowerCase()) &&
                (this.conv.parseRuntime.delimiter = this.getDelimiter(t)),
              this.needEmitDelimiter &&
                !this.delimiterEmitted &&
                (this.conv.emit("delimiter", this.conv.parseRuntime.delimiter), (this.delimiterEmitted = !0));
            var n = this.conv.parseRuntime.delimiter,
              i = t.split(n);
            if ("off" === e) {
              if (r) for (var o = 0; o < i.length; o++) i[o] = i[o].trim();
              return { cells: i, closed: !0 };
            }
          ...
          (t.prototype.toCSVRow = function (t, e, r, n) {
            for (var i = [], s = !1, a = "", u = 0, c = t.length; u < c; u++) {
              ...
              if (s)
                this.isQuoteClose(l)
                  ? ((s = !1), (a += n + (l = l.substr(0, f - 1))), (a = this.escapeQuote(a)), e && (a = o.trimRight(a)), i.push(a), (a = ""))
                  : (a += n + l);
              else {
                ...
                if (this.isQuoteOpen(l)) {
                  ...
                  if (-1 !== l.indexOf(r)) {
                    for (var h = 0, p = 0, d = l; p < d.length; p++) d[p] === r && h++;
                    if (h % 2 == 1) {
          ...
          (t.prototype.parseMultiLines = function (t) {
            for (var e = [], r = ""; t.length; ) {
              var n = r + t.shift(),
                s = this.parse(n);
              (0 === s.cells.length && this.conv.parseParam.ignoreEmpty) ||
                (s.closed || this.conv.parseParam.alwaysSplitAtEOL
                  ? (this.conv.parseRuntime.selectedColumns
                      ? e.push(o.filterArray(s.cells, this.conv.parseRuntime.selectedColumns))
                      : e.push(s.cells),
                    (r = ""))
                  : (r = n + (i.default(n, this.conv.parseRuntime) || "\n")));
            }
            return { rowsCells: e, partial: r };
          }),
          t
        );
      })();
  ...
  function (t, e, r) {
    ...
    var i = n(r(29)),
      ...
      s = /^[-+]?[0-9]*\.?[0-9]+([eE][-+]?[0-9]+)?$/;
    function a(t, e, r) {
      if (e.parseParam.checkColumn && e.parseRuntime.headers && t.length !== e.parseRuntime.headers.length)
        throw i.default.column_mismatched(e.parseRuntime.parsedLineNumber + r);
      return (
        (function (t, e, r) {
    ...
    function l(t, e, r, n, i) {
      n.parseRuntime.columnValueSetter[i] ||
        (n.parseParam.flatKeys
          ? (n.parseRuntime.columnValueSetter[i] = f)
          : e.indexOf(".") > -1
          ? n.parseParam.colParser[e] && n.parseParam.colParser[e].flat
            ? (n.parseRuntime.columnValueSetter[i] = f)
            : (n.parseRuntime.columnValueSetter[i] = h)
          : (n.parseRuntime.columnValueSetter[i] = f)),
        n.parseRuntime.columnValueSetter[i](t, e, r);
    }
    function f(t, e, r) {
      t[e] = r;
    }
    ...
    function p(t, e, r, n) {
      return n.parseRuntime.headerType[r]
        ? n.parseRuntime.headerType[r]
        : e.indexOf("number#!") > -1
        ? (n.parseRuntime.headerType[r] = d)
        : e.indexOf("string#!") > -1
        ? (n.parseRuntime.headerType[r] = _)
        : n.parseParam.checkType
        ? (n.parseRuntime.headerType[r] = v)
        : (n.parseRuntime.headerType[r] = _);
    }
    function d(t) {
      var e = parseFloat(t);
    ...
    function v(t) {
      ...
      return "" === e
        ...
        : s.test(e)
        ? d(t)
        : (5 === e.length && "false" === e.toLowerCase()) || (4 === e.length && "true" === e.toLowerCase())
        ? (function (t) {
            var e = t.trim();
  ...
  function (t, e, r) {
    ...
    var i = n(r(14)),
      o = (function () {
        ...
        return (
          Object.defineProperty(t.prototype, "needEmitLine", {
            get: function () {
          ...
          Object.defineProperty(t.prototype, "needPushDownstream", {
            get: function () {
              return (
                void 0 === this._needPushDownstream &&
          ...
          (t.prototype.processResult = function (t) {
            var e = this;
            return (
              this.converter.parseRuntime.parsedLineNumber,
              new i.default(function (r, n) {
                e.needEmitLine
                  ? (function t(e, r, n, i, o) {
                      if (n >= e.length) o();
                      else if (r.parseRuntime.subscribe && r.parseRuntime.subscribe.onNext) {
                        var a = r.parseRuntime.subscribe.onNext,
                          u = e[n],
                          c = a(u, r.parseRuntime.parsedLineNumber + n);
                        if ((n++, c && c.then))
                          c.then(function () {
                            !(function (e, r, n, i, o, a, u) {
                              o && s(n, u), t(e, n, i, o, a);
                            })(e, 0, r, n, i, o, u);
                          }, o);
                        else {
                          for (i && s(r, u); n < e.length; ) {
                            var l = e[n];
                            a(l, r.parseRuntime.parsedLineNumber + n), n++, i && s(r, l);
                          }
                          o();
                        }
                      } else {
                        if (i) for (; n < e.length; ) (l = e[n++]), s(r, l);
                        o();
                      }
          ...
          (t.prototype.processError = function (t) {
            this.converter.parseRuntime.subscribe &&
              ...
              this.converter.parseRuntime.subscribe.onError(t),
              this.converter.parseRuntime.then && this.converter.parseRuntime.then.onrejected && this.converter.parseRuntime.then.onrejected(t);
          }),
    ...
    function s(t, e) {
      "object" != typeof e || t.options.objectMode ? t.push(e) : t.push(JSON.stringify(e) + "\n", "utf8");
    }
    e.Result = o;
  },
]);
